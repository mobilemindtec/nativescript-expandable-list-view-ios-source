Pod::Spec.new do |s|
  ...
  s.homepage     = "git@github.com:mobilemindtec/nativescript-expandable-list-view-ios-source.git"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { "orta" => 'ricardo@mobilemind.com.br' }
  s.source       = { :git => "git@github.com:mobilemindtec/nativescript-expandable-list-view-ios-source.git", :tag => s.version.to_s }
  s.platform     = :ios, '8.0'
